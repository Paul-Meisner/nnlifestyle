...
Some features on this site are paid placements. Brands pay to be featured on our [partners page](/partners/) and in dedicated feature articles.

How we handle it:

- Every paid feature is clearly labeled as sponsored on the page itself, above the fold — not in a footnote
- Outbound links in paid features are marked with `rel="sponsored"`
- Payment does not buy a favorable opinion, and it does not exempt a brand from our editorial standards
...
If we receive a product free of charge for review, we'll say so in that article.
